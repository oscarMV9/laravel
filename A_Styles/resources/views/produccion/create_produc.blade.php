...
<div class="wrapper">
    <form action="{{ route('produccion.store') }}" method="POST">
        ...
        <div class="input-box">
            ...
            <input type="date" class="form-control" id="fecha_fin_produccion" name="fecha_fin_produccion">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
            ...
            <input type="number" class="form-control" id="id_encargado" name="id_encargado" required>
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
            ...
            <input type="text" class="form-control" id="apellido_encargado" name="apellido_encargado" required>
        </div>
